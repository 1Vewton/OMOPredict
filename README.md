...
| 前端 | Vue 3 + TypeScript | `frontend/`（M4 规划中） | 参数设计、图表可视化、任务历史 |

## 功能状态（里程碑）

- ✅ M0 脚手架 + CI（Python ruff/pytest + Go fmt/vet/build/test）
...
- **各层**：`engine/README.md`、`server/README.md`
